...
class Proyecto {
  ...
  const projectCard1 = new Proyecto(
      /* Id */ "project1",
      /* Logo */ "./img/Proyectos/ArgetinaPrograma.png",
      /* Título */ "Curriculum - Argentina Programa",
      /* Descripción */ `El código HTML proporcionado parece ser la estructura básica de un sitio web que consta de varias secciones, como un encabezado con un menú de navegación, una sección de certificaciones con un carrusel de imágenes y un botón de contratación, una sección "Sobre mí" con información personal y una imagen de perfil, una sección de habilidades con gráficos de barras, una sección de contacto con un formulario y un botón para enviarlo, y una sección de proyectos que parece estar incompleta. Además, el código incluye referencias a hojas de estilo CSS y a las bibliotecas Font Awesome y Chart.js para el uso de iconos y gráficos respectivamente. También se incluyen algunos scripts para controlar el comportamiento del sitio, como el cambio de modo nocturno y la descarga de un archivo PDF de un currículum vitae. En general, parece ser un proyecto para crear un sitio web personal con información sobre el autor y sus habilidades y proyectos.`,
      /* Requerimientos */ ["Modo nocturno", "Graficos creados mediante Chart.Js","Tarjetas dinamicas en base a objetos","Formulario de envio con php"],
      /* Lenguajes */ "HTML, CSS, JS",
      /* Librerías */ "-",
      /* Imagen */ "./img/Proyectos/Tarjeta_Proyecto1.jpg",
